...
export function validationQueryPipe<T>(type: new () => T): (req: Request, res: Response, next: NextFunction) => void {
     return async (req: Request, res: Response, next: NextFunction): Promise<any> => {
          ...
          try {
               ...
               // Merge validated DTO back into req.query (can't directly reassign req.query as it's a getter)
